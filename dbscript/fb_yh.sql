DROP TABLE IF EXISTS `forbes`.`fb_yh`;
CREATE TABLE  `forbes`.`fb_yh` (
...
DROP TABLE IF EXISTS `forbes`.`fb_yh_dy`;
CREATE TABLE  `forbes`.`fb_yh_dy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `forbes`.`fb_yh_log`;
CREATE TABLE  `forbes`.`fb_yh_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
