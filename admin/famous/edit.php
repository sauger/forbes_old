	...
	<table width="795" border="0">
		...
		<tr class=tr4>
			...
			<td width="695" align="left">
				<input type="text" name="mr[name]" value="<?php echo $famous->name;?>">
			</td>
		</tr>
		<tr class=tr4>
			<td>性别</td>
			<td align="left">
				<input type="radio" name="mr[xb]" value="0" <?php if($famous->xb=='女'){ ?>checked="checked"<?php } ?>>女
				<input type="radio" name="mr[xb]" value="1" <?php if($famous->xb=='男'){ ?>checked="checked"<?php } ?>>男
			</td>
		</tr>
		<tr class=tr4>
			<td width="130">职业</td>
			<td align="left">
				<input type="text" name="mr[zy]" value="<?php echo $famous->zy;?>">
			</td>
		</tr>
		<tr class=tr4>
