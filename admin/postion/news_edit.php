	...
	<table cellspacing="1" align="center">
		...
		?>
				<tr class=tr3 id=<?php echo $record[$i]->id;?> >
					<td style="text-align:left; text-indent:12px;"><a href="<?php echo "/admin/news/news_edit.php?id={$record[$i]->id}";?>"><?php echo strip_tags($record[$i]->title);?></a></td>
					<td>
		...
		?>
		<tr class="tr3">
			<td colspan=5><?php paginate();?>　<button id=edit_priority>编辑优先级</button><input type="hidden" id="list_id" value="<?php echo $id?>"> 		<input type="hidden" id="p_type" value="news"></td>
		</tr>
	</table>
</div>	
</body>
