...
<div id=itable>	
	<table cellspacing="1" align="center">
		...
		<? }?>
		<tr class=tr3>
				<td colspan="3"><button id=edit_priority>编辑优先级</button><input type="hidden" id="list_id" value="<?php echo $id?>"><input type="hidden" id="p_type" value="column">	<input type="hidden" id="db_table" value="<?php echo $user_table;?>"></td>
		</tr>
	</table>
</div>	
</body>
