	...
	$("#add_company").click(function(){
		if($("#gsid").val()==''){
			...
			if($.inArray($("#gsid").val(),company_array)>-1){
				...
				$("#a_com").after('<tr class=tr4><td>关联公司</td><td align="left">'+$("#gsid option:selected").text()+'　持股数：<input class="number required" type="text" name="stock[]">单位为100股，即1代表100股　<button class="del_com" type="button">删除</button><input class="h_company" name="company[]" type="hidden" value="'+$("#gsid").val()+'"></td></tr>');
