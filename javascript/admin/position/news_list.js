...
$(function(){
	...
	$(".revocation").live('click',function(){
		var ob = $(this);
		$.post('postion.post.php',{'type':'revocation','nid':$(this).attr("name"),'p_type':'news'},function(data){
			window.location.reload();
		});
	})
	...
	$("#edit_priority").click(function(){
		...
		$.post("postion.post.php",{'id_str':id_str,'priority_str':priority_str,'pid':$("#list_id").val(),'type':'edit_priority','p_type':'news'},function(data){
			window.location.reload();
		});		
	})
});